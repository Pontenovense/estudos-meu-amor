...
const defaultFrases = [
  ...
  { texto: 'Cada dia é uma nova oportunidade para aprender algo incrível.', autor: 'Estudos Meu Amor' },
  { texto: 'A persistência é o caminho do êxito.', autor: 'Charles Chaplin' },
  { texto: 'Você não precisa ser perfeito, precisa ser persistente.', autor: 'Estudos Meu Amor' },
  ...
  { texto: 'Acredite em você. Cada hora de estudo te aproxima dos seus sonhos.', autor: 'Estudos Meu Amor' },
  { texto: 'O futuro pertence àqueles que se preparam para ele hoje.', autor: 'Malcolm X' },
  { texto: 'Grandes conquistas começam com pequenos passos diários.', autor: 'Estudos Meu Amor' },
  { texto: 'A mente que se abre a uma nova ideia jamais volta ao seu tamanho original.', autor: 'Albert Einstein' },
  { texto: 'Sua dedicação de hoje é o seu sucesso de amanhã.', autor: 'Estudos Meu Amor' },
